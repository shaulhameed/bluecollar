...
class StreamingHoundClient(_BaseHoundClient):
    ...
    def __init__(self, clientID, clientKey, userID, requestInfo=dict(), hostname=HOUND_SERVER, sampleRate=16000,
                 useSpeex=False):
        """
    ...
    def _callback(self, listener):
        ...
        for line in self._readline(self.conn.sock):
            ...
            if "Format" in parsedMsg:
                if parsedMsg["Format"] == "SoundHoundVoiceSearchParialTranscript" or parsedMsg[
